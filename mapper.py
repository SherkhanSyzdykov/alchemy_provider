...
from sqlalchemy import Column, String, BigInteger, ForeignKey, Boolean, \
    DateTime, PrimaryKeyConstraint, Float, SmallInteger, func, Index
...
class Device(AbstractBaseMapper):
    ...
    device_type_id = Column(
        BigInteger,
        ForeignKey('ami_device_type.id', ondelete='SET NULL')
    )
    device_type = relationship('DeviceType', back_populates='devices')

    __table_args__ = (
        Index('idx_device_geo_data', geo_data, postgresql_using='gist'),
    )
